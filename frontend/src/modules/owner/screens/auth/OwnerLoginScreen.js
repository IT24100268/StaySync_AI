...
export default function OwnerLoginScreen({ navigation }) {
  const { signIn, authenticating } = useOwnerAuth();
  ...
  return (
    <ScreenContainer contentContainerStyle={styles.content}>
      <View style={styles.hero}>
        <Text style={styles.title}>Owner dashboard access</Text>
        <Text style={styles.subtitle}>
          Manage listings, track booking requests, and monitor room performance.
        </Text>
      </View>
      ...
      <View style={styles.card}>
        ...
        />
        <Text style={styles.note}>Demo login: owner@staysync.ai / password123</Text>
      </View>
    </ScreenContainer>
  );
}
