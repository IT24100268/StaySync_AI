...
export default function DeliveryRegisterScreen({ navigation }) {
  const { signUp, authenticating } = useDeliveryAuth();
  ...
  return (
    <ScreenContainer>
      <View style={styles.card}>
        ...
        {errors.vehicleType ? <AppInput value="" editable={false} label="" error={errors.vehicleType} /> : null}
        ...
        <AppButton title="Register Delivery Partner" onPress={handleSubmit} loading={authenticating} />
