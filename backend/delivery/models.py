...
class UserProfile(models.Model):
    ...
    user = models.OneToOneField(settings.AUTH_USER_MODEL, on_delete=models.CASCADE, related_name='delivery_user_profile')
...
class DeliveryPartner(models.Model):
    ...
    reviewed_by = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.SET_NULL, null=True, blank=True, related_name='reviewed_delivery_partners')
    created_at = models.DateTimeField(auto_now_add=True)
